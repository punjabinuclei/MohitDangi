            ...
            <div className="border-b-2 pb-16 border-[#D9D9D6] mb-10 text-center md:text-left">
                ...
                <div className="md:grid grid-cols-2 gap-20 justify-items-center">
                    <div className="pt-[46px] md:pt-[96px]">
                        ...
                        <p className="text-[0.8rem] text-neutral-600 font2 md:text-[1.1rem] tracking-widest pb-8 md:pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Faucibus fringilla dui amet faucibus nam. Erat id laoreet posuere etiam morbi.</p>
                    ...
                    <div className="relative">
                        <div className="relative md:bottom-28" >
                            ...
                            <p className="text-neutral-600 text-[0.8rem] md:text-[1.1rem] font2 tracking-widest pb-8 md:pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Faucibus fringilla dui amet faucibus nam.</p>
                        </div>
                        <div className="relative md:bottom-16">
                            ...
                            <p className="text-[0.8rem]  text-neutral-600 md:text-[1.1rem] font2 tracking-widest pb-8 md:pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Faucibus fringilla dui amet faucibus nam.</p>
                        </div>
                    </div>
                </div>
