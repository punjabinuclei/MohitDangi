...
const Navbar = () => {
    return (
        <Container>
            <div className="flex justify-between md:justify-between pt-8 ">
                <div className="md:flex">
                    <h1 className="md:text-[2rem] relative top-1 md:bottom-4"><span className="text-[#996830]">MOHIT</span> DANGI</h1>
                </div>
                <div className="hidden md:flex justify-between font2 tracking-tight text-[0.9rem] font-semibold">
